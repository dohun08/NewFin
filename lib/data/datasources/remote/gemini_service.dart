...
class GeminiService {
  ...
  Future<List<FinancialTermModel>> extractTerms(String content) async {
    ...
    final prompt = '''
    다음 뉴스 내용에서 10대 학습자가 배워야 할 중요한 금융/경제 용어를 3~5개 추출하고, 
    ...
    [
      {
        "term": "용어",
        "definition": "10대가 이해할 수 있는 쉬운 설명 1~2문장",
        "example": "실생활 예시 문장 1개"
      },
      ...
    ]
    ''';
    ...
    try {
      ...
      if (responseText != null) {
        ...
        return jsonList.map((json) => FinancialTermModel(
          term: json['term'],
  ...
  Future<List<QuizModel>> generateQuiz(String newsSummary, String newsId) async {
    print('\n[✨ Gemini] 퀴즈 생성 요청');
    ...
    try {
      ...
      if (responseText != null) {
        ...
        return jsonList.map((json) => QuizModel(
          id: _uuid.v4(),
          newsId: newsId,
